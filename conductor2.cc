...
void processRegion (integer n, integer start, integer stop, integer gap, integer me) {
   const std::string command = std::string("./miscFiles/theta_int_double2 ") + std::to_string(start) + std::string(" ") + std::to_string(stop) + std::string{" "} + std::to_string(gap) + std::string(" &> ./out2/") + std::to_string(n);
...
const integer gap = 1000000000000;
const integer recordEvery = 10000000000;
